...
class WatchlistActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: Toolbar = toolbar_watchlist
        ...
        val drawerLayout: DrawerLayout = findViewById(R.id.drawer_layout_watchlist)
        val navView: NavigationView = findViewById(R.id.nav_view_watchlist)
